...
* Shreyas Misra, BSc., Brown University, 2024
  * [Honors Thesis: Using Reinforcement Learning for Variable Selection in the Branch and Bound Algorithm for Solving Mixed Integer Linear Programs](https://cs.brown.edu/media/filer_public/be/7d/be7d5798-e4a2-4053-8ed5-afcdea8217dc/mishrashreyas_dutt.pdf)
* Vignesh Pandiarajan and Cristina Hu, BSc., Brown University, 2024
  * [Capstone Project: Explorateur: State-Space Search](https://cs.brown.edu/media/filer_public/81/fe/81fec96a-c739-461c-ac99-b1e447271d11/hucristina_pandiarajanvignesh_capstone_abstract.pdf) available on [Explorateur](https://github.com/skadio/explorateur/)
* Paul Biberstein, BSc., Brown University, 2023
  * [Capstone Project: bandit-based local search](https://cs.brown.edu/media/filer_public/ba/c5/bac53530-7432-4d04-870f-701e7b7dcdb0/bibersteinpaul.pdf), added to [ALNS](https://alns.readthedocs.io/en/latest/examples/alns_features.html#More-advanced-bandit-algorithms)
* Ansel Vahle, Valentin Perez, Sean Segal, BSc., Brown University 2018 
  * [Capstone Project: Boolean Satisfiability](https://cs.brown.edu/media/filer_public/ab/07/ab078691-8c27-4d68-b2b0-b2fa39c3b48a/vahleansel.pdf) on [Online SAT Solving](https://github.com/skadio/cs2951o-capstone)
...
* Zohair Shafi, Northeastern University, 2025
  * [Forge: Foundational Optimization Embeddings](https://arxiv.org/abs/2508.20330), ArXiv'25, NeurIPS'25
* Alican Yilmaz, Northeastern University, 2025
  * [ParBalans: Parallel Balans](https://arxiv.org/abs/2508.06736), ArXiv'25
* Weijia Jing, Northeastern University, 2024
* Aishwarya Kumar, Northeastern University, 2024
* Akshay Reddy Nagireddy, Northeastern University, 2023
  * [CD/CI pipeline using GitHub actions](https://github.com/skadio/atlas_docker)
...
* Priya Singh, MSc., Northeastern University, 2019
* Pablo Colunga, MSc., Northeastern University, 2019
  * [Seq2Pat: Sequence-to-Pattern Generation](https://github.com/fidelity/seq2pat), `INFORMS 2020`
* Emily Strong, MSc, Northeastern University, 2018
