...
- [Balans](https://coin-or.github.io/balans/) — Online Learnign Meta-solver for Decision Making  <br> <span style="color:green">Best paper nominee at IJCAI</span> 
- [Forge](https://skadio.github.io/forge/) —  Foundational Optimization Representations <br> <span style="color:green">The first pre-trained model for mixed-integer programs</span> 
