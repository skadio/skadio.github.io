...
### Latest Collections 
- [Text2Model](https://skadio.github.io/text2model/): LLM Modeling Copilots <span style="color:green"></span> 
- [Mab2Rec](https://fidelity.github.io/mab2rec): Bandit-based Recommender Systems <span style="color:green">Downloaded more than 3M+ times in the AI community. Deployed by enterprises worldwide.</span> 
- [Balans](https://coin-or.github.io/balans/): Online Learnign Meta-solver for Decision Making <span style="color:green">Best paper nominee at IJCAI</span> 
- [Forge](https://skadio.github.io/forge/): Foundational Optimization Representations <span style="color:green">The first pre-trained model for mixed-integer programs</span> 
...
- [BoolXAI](https://fidelity.github.io/mab2rec/#boolxai): Explainable AI using expressive Boolean formulas
- [Jurity](https://fidelity.github.io/mab2rec/#jurity): Fairness and bias mitigation, and recommender system evaluation techniques

---

### Personalization & Recommender Systems

- [Mab2Rec](https://fidelity.github.io/mab2rec) End-to-end framework for building bandits-based recommenders from raw interaction data to feature generation, model evaluation and deployment
- [MABWiser](https://fidelity.github.io/mab2rec/#mabwiser) Parallelizable, contextual multi-armed bandits library with simulation capabilities

---

### Natural Language Processing

- [Ner4Opt](https://skadio.github.io/text2model/#ner4opt): Named-entity extraction for optimization
- [TextWiser](https://fidelity.github.io/mab2rec/#textwiser) Text featurization NLP library that unifies several text embedding techniques

---

### Pattern Mining 

- [Seq2Pat](https://fidelity.github.io/mab2rec/#seq2pat) Sequence-to-Pattern generation library to find frequent patterns from large sequence databases. Joint work with CMU 

---

### Feature Selection 

- [Selective](https://fidelity.github.io/mab2rec/#selective) A white-box feature selection library that supports unsupervised and supervised selection methods for classification and regression tasks
