...
* `CPAIOR 2023` [NER4OPT: Named Entity Recognition for Optimization](https://link.springer.com/chapter/10.1007/978-3-031-33271-5_20), Parag Dakle, Serdar Kadioglu, Karthik Uppuluri, Regina Politi, Preethi Raghavan, SaiKrishna Rallabandi, Ravisutha Srinivasamurthy, [International Conference on the Integration of Constraint Programming, Artificial Intelligence, and Operations Research](https://sites.google.com/view/cpaior2023) [[Presentation Slides]](https://nbviewer.org/github/skadio/skadio.github.io/blob/master/files/Kadioglu_CPAIOR_2023.pdf) [[library]](https://github.com/skadio/ner4opt) [[Hugging Face demo]](https://huggingface.co/spaces/skadio/Ner4Opt)
* `NeurIPS 2022` [Natural Language for Optimization](https://nbviewer.org/github/skadio/ner4opt/blob/main/docs/%5BNeurIPS+2022%5D+Ner4Opt+Poster.pdf), Parag Dakle, Serdar Kadioglu, Karthik Uppuluri, Regina Politi, Preethi Raghavan, SaiKrishna Rallabandi, Ravisutha Srinivasamurthy, [Conference on Neural Information Processing Systems](https://nl4opt.github.io/) [[library]](https://github.com/skadio/ner4opt) [[Hugging Face demo]](https://huggingface.co/spaces/skadio/Ner4Opt)
...
## Responsible AI 
* `MAKE 2023` [Explainable AI using expressive Boolean formulas](https://www.mdpi.com/2504-4990/5/4/86), Gili Rosenberg, J. Kyle Brubaker, Martin J. A. Schuetz, Grant Salton, Zhihuai Zhu, Elton Yechao Zhu, Serdar Kadıoğlu, Sima E. Borujeni, Helmut G. Katzgraber, [Machine Learning and Knowledge Extraction - XAI](https://www.mdpi.com/journal/make/special_issues/0T6AZ35M66)
...
## Recommender Systems
* `TMLR 2022` [Non-Deterministic Behavior of Thompson Sampling with Linear Payoffs and How to Avoid It](https://openreview.net/pdf?id=sX9d3gfwtE), Doruk Kilitcioglu, Serdar Kadioglu, [Transactions on Machine Learning Research](https://openreview.net/forum?id=sX9d3gfwtE) <span style="color:green"> Received TMLR's first reproducibility certificate</span>
...
* [Systems and methods for providing dynamic and real time simulations of matching resources to requests](https://scholar.google.com/citations?view_op=view_citation&hl=en&user=tOgYtHkAAAAJ&cstart=20&pagesize=80&sortby=pubdate&authuser=1&citation_for_view=tOgYtHkAAAAJ:Aul-kAQHnToC), US Patent 10146665, 2018
* [Assigning applications to virtual machines using constraint programming](https://scholar.google.com/citations?view_op=view_citation&hl=en&user=tOgYtHkAAAAJ&citation_for_view=tOgYtHkAAAAJ:cWzG1nlazyYC), US Patent 10007538, 2018
* [System and method of assigning requests to resources using constraint programming](https://scholar.google.com/citations?view_op=view_citation&hl=en&user=tOgYtHkAAAAJ&citation_for_view=tOgYtHkAAAAJ:WJVC3Jt7v1AC), US Patent 9588819, 2017 
