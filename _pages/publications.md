...
## Recommender Systems
* `TMLR 2022` [Non-Deterministic Behavior of Thompson Sampling with Linear Payoffs and How to Avoid It](https://openreview.net/pdf?id=sX9d3gfwtE), Doruk Kilitcioglu, Serdar Kadioglu, [Transactions on Machine Learning Research](https://openreview.net/forum?id=sX9d3gfwtE)
